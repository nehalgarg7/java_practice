...
class Sample3 extends Sample2 implements A3,B3
{
	...
	{
		System.out.println("This is a display1 method inside child class Sample2 from Interface A3 ");
	}
	
	public void display2()
	{
		System.out.println("This is a display2 method inside child class Sample2 from Interface B3");
	}
	...
	public void run(int x) {
		...
		System.out.println("This is a run overloaded method from abstract class Sample2");
	}
